    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{Route('dep.cadastro')}}" method="post" id="step-form-horizontal" class="step-form-horizontal">
                            @csrf()
                            <div>  
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="head_dept" id= "name1" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                <label for="name2"class="text-label">Data de inicio</label>
                                                <input type="date" name="starting_date" id= "name2" class="form-control" required>
                                            </div>
                                        </div>
