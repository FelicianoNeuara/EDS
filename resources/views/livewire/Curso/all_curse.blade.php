            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                        <img class="img-fluid" src="{{ asset('assets/images/pic1.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic2.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic3.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic4.jpg') }}" alt="">
							<div class="card-body">
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic5.jpg') }}" alt="">
							<div class="card-body">
								<h4>Why is Early Education Essential?</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0 text-muted">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic6.jpg') }}" alt="">
							<div class="card-body">
								<h4>The Shocking Revelation of Education.</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0 text-muted">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                            <img class="img-fluid" src="{{ asset('assets/images/pic7.jpg') }}" alt="">
							<div class="card-body">
								<h4>Five Things Nobody Told You About</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0 text-muted">April 23</span>
					...
					<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6">
						<div class="card">
                        	<img class="img-fluid" src="{{ asset('assets/images/pic8.jpg') }}" alt="">
							<div class="card-body">
								<h4>Learn Python – Interactive Python Tutorial</h4>
								<ul class="list-group mb-3 list-group-flush">
									<li class="list-group-item px-0 border-top-0 d-flex justify-content-between"><span class="mb-0 text-muted">April 23</span>
								...
								<a href="{{Route('detalhe.curso')}}" class="btn btn-primary">Read More</a>
							</div>
						</div>
					</div>
				</div>
