    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{Route('home1')}}" class="brand-logo">
                ...
                <ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="professor-profile.html">Perfil</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{Route('estudante.index')}}">Estudante</a></li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{Route('curso.view')}}">Cursos em vigor</a></li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Aula</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{route('aula.index')}}">Aula</a></li>
                        </ul>
                    </li>
					...
					<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{Route('matricula.index')}}">Matriculas</a></li>
