    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{Route('professor.cadastro')}}" method="post" id="step-form-horizontal" class="step-form-horizontal">
                            @csrf()
                            <div>  
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_birth"  class="datepicker-default form-control" required>
                                            </div>
                                        </div>
