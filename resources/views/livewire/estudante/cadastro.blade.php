                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="date_of_birth"  class="datepicker-default form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-4">
                                            <div class="form-group">
                                                <label class="text-label">Data de registro</label>
                                                <input type="text" name="registration_date" class="datepicker-default form-control" required>
                                            </div>
                                        </div>
                                    </div>
